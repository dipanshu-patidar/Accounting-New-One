...
const Plans = () => {
    ...
    const [plans, setPlans] = useState([
        {
            ...
            status: 'Active',
            modules: [
                { name: 'Account', price: 54.00, enabled: true },
                { name: 'Purchase', price: 45.00, enabled: true },
                { name: 'Sales', price: 44.99, enabled: true },
        ...
        },
        {
            ...
            status: 'Active',
            modules: [
                { name: 'Account', price: 877.98, enabled: true },
                { name: 'Sales', price: 678.00, enabled: true },
                { name: 'User Management', price: 787.00, enabled: true },
                { name: 'Inventory', price: 0, enabled: false },
                { name: 'POS', price: 0, enabled: false },
    ...
    const initialFormState = {
        ...
        basePrice: 0,
        currency: 'USD',
        invoiceLimitOption: '10 invoices',
        invoiceLimitCustom: '',
        addInvoicePrice: 0,
        userLimitOption: '1 user',
        userLimitCustom: '',
        storageOption: '5 GB',
        storageCustom: '',
        billing: 'Monthly',
    ...
    const openEditModal = (plan) => {
        ...
        setFormData({
            ...
            invoiceLimitOption: plan.invoiceLimit, // Simplified mapping
            addInvoicePrice: plan.addInvoicePrice, // Clean number
            userLimitOption: plan.userLimit,
            storageOption: plan.storage,
                    ...
                    <table className="plans-table">
                        ...
                        <tbody>
                            {plans.map(plan => (
                                <tr key={plan.id}>
                                    <td>
                                        <span className={`badge-plan ${plan.name === 'Bronze' ? 'bg-bronze' : 'bg-pro'}`}>
                                            {plan.name}
                                        </span>
                                    </td>
                                    <td>{plan.currency}</td>
                                    ...
                                    <td>${plan.addInvoicePrice}/invoice</td>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-row three-col">
                                <div className="form-group">
                                    ...
                                    <div className="input-group">
                                        <select name="invoiceLimitOption" value={formData.invoiceLimitOption} onChange={handleInputChange}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        type="number"
                                        name="addInvoicePrice"
                                        value={formData.addInvoicePrice}
                                        onChange={handleInputChange}
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="userLimitOption" value={formData.userLimitOption} onChange={handleInputChange}>
                            ...
                            <div className="form-row two-col">
                                <div className="form-group">
                                    ...
                                    <select name="storageOption" value={formData.storageOption} onChange={handleInputChange}>
                                        <option>5 GB</option>
                                        <option>10 GB</option>
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="billing" value={formData.billing} onChange={handleInputChange}>
                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <div className="modal-body view-body">
                            ...
                            <div className="view-row"><strong>Billing:</strong> <span>{selectedPlan.billing}</span></div>
